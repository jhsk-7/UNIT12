...
const planetCriteria = planets.filter(function(planet){
    const checkTemp = (planet.temperature >= 253 && planet.temperature <= 323)
    const checkDistance = (planet.distance >= .75 && planet.distance <= 20)
    return checkTemp && checkDistance
})

console.log(planetCriteria)